package com.sampoom.factory.common.response;
...
public enum ErrorStatus {
    ...
    INVALID_FACTORY_FOR_PART_ORDER(HttpStatus.BAD_REQUEST, "해당 공장의 주문이 아닙니다.", 40009),
    CANNOT_CANCEL_PROCESSED_ORDER(HttpStatus.BAD_REQUEST, "이미 처리 중인 주문은 취소할 수 없습니다.", 400010),
